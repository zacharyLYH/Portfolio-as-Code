                      ...
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger className='flex'>
                            ...
                            <span>{formatDate(exp.startDate!)} - {exp.isCurrent ? 'Present' : (exp.endDate ? formatDate(exp.endDate) : '')}</span>
                          </TooltipTrigger>
                          <TooltipContent>
                    ...
                    <AccordionContent>
                      <Card itemID={exp.id}>
                        <CardContent>
                          ...
                          {exp.description && exp.links.length > 0 && <Separator className="my-4" />}
                          {exp.links.length > 0 && (
                            <div className="my-4">
                          ...
                          {exp.skills.length > 0 && exp.links.length > 0 && <Separator className="my-4" />}
                          {exp.skills.length > 0 && (
                            <div className="my-4">
